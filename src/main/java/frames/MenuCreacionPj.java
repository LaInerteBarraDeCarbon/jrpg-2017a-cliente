...
/**
 * Clase que crea el menú de creación de un personaje. <br>
 */
...
public class MenuCreacionPj extends JFrame {
	...
	/**
	 * Lista de selección de Casta. <br>
	 */
	private JComboBox<String> cbxCasta;
	/**
	 * Lista de selección de Raza. <br>
	 */
	...
	public MenuCreacionPj(final Cliente cliente, final PaquetePersonaje personaje) {
		...
		layeredPane.add(lblBackground, new Integer(Constantes.CERO));
